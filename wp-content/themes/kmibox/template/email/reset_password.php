...
$HTML = "
		<div style=\"
			...
			text-align:center;
		\">
			<img src=\"".get_home_url()."/wp-content/themes/kmibox/imgs/Image-footer.png\">
		</div>
		<div style=\"
			...
			<p>Hola <stronge>".$name."</stronge>, hemos recibido una solicitud para restablecer la contraseña de tu perfil NutriHeroes.</p>
