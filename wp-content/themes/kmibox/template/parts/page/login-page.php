			...
			<form id='form-login' class="form-horizontal">
				...
				<div class="form-group">
					<div class="text-center">
						...
						<a href="<?php echo get_home_url().'/'; ?>registro" id='link-registro' data-target="inicio-sesion" ><label style="color: #ffffff; font-size: 10px" class="gothan">Registrate aquí</label>							
						</a>
					</div>
				</div>
