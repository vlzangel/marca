...
<!-- Cliente Registrado -->
<div class="modal fade" tabindex="-1" role="dialog" id="cliente_nuevo" data-backdrop='false'>
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Modal title</h4>
      ...
      <div class="modal-footer">
        <button id="cliente_nuevo_action" type="button" class="btn btn-primary">Aceptar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->