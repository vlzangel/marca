...
<article class="row profile-content whereisit-kmibox">
	...
	<div class=" border-radius:10px; border:1px solid #ccc; col-md-4 col-xs-12 col-md-offset-2"
		...
		<h3 class="responsive-marca" style="color: #94d400; font-family: caviar_dreamsregular">Selecciona una suscripción</h3>
			...
			<div class="border-curvo col-md-12 col-sm-12 col-md-12 text-center">				
				<div class="row" id="content-estatus">
					<div data-ubicacion="armada" class="col-xs-6 col-sm-3 col-md-3 pull-left selected">
						...
						<label class="hidden-xs hidden-sm caviar" style="font-family: caviar_dremasregular">Armada</label>
						<li class="hidden-sm hidden-md hidden-lg list-inline list-unstyle" id="leyenda"><span></span><label style="font-family: caviar_dremasregular">Armada</label></li>
					</div>
					...
					<div data-ubicacion="enviada" class="col-xs-6 col-md-3 col-sm-3 selected">
						...
						<label class="hidden-xs hidden-sm caviar" style="font-family: caviar_dremasregular">Enviada</label>
						<li class="hidden-sm hidden-md hidden-lg list-inline list-unstyle" id="leyenda"><span></span><label style="font-family: caviar_dremasregular" >Enviada</label></li>
					...
					<div data-ubicacion="recibida" class="col-xs-12 col-md-3 col-sm-3 selected">
						...
						<label class="hidden-xs hidden-sm caviar" style="font-family: caviar_dremasregular">Recibida</label>
						<li class="hidden-sm hidden-md hidden-lg list-inline list-unstyle" id="leyenda"><span></span><label style="font-family: caviar_dremasregular">Recibida</label></li>
