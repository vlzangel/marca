...
<section data-fase="6" class="container">
	...
	<article id="pago_exitoso" class="col-md-10 col-xs-12 col-md-offset-1 text-center" style="border-radius:30px;padding:20px;border:1px solid #ccc; overflow: hidden; margin-top: 3%;">
		...
		<aside class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
	      	<a href="<?php echo $CARRITO["PDF"]; ?>" target="_blank" class="btn btn-defaut" 
				style="
				    width: 93%;
				    font-size: 13px;
				    text-align: center;
				    ...
				    border-color: #000;
				    border-radius: 25px;
			    ">Instrucciones para completar el pago</a>
		</aside>
