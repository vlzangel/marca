...
<div class="container" style="margin-top: 2%">		
	<div style="float:right;width:50%;"> 
		...
		<img src="<?php echo get_home_url(); ?>/img/Image-footer.png" class="hidden-md hidden-xs hidden-lg" width="85%" style="margin-top: 6%">
		<img src="<?php echo get_home_url(); ?>/img/Image-footer.png" class="hidden-xs hidden-sm" width="50%" style="margin-top: -46%; margin-left: 55%;">
	</div>		 	
	<div style="float:right;width:50%;"> 
		<article class="col-sm-12  text-left">
			<h3 class="caviar">Contáctanos</h3>
			<ul class="list-unstyled">
				<li class="caviar" style="color: #ffffff">+52 (55) 1791.4931</li>
				<li class="caviar" style="color: #ffffff">+52 (55) 66319264</li>
				<li class="caviar" style="color: #ffffff">Llamada Sin Costo: (01) 800 056 4667</li>
	...
	<article class="col-sm-6  text-left">
			...
			<ul class="list-inline hidden-lg hidden-md hidden-sm" id="social-network">
				<li><img src="<?php echo get_home_url(); ?>/img/wl_fb.png"></li>
				<li><img src="<?php echo get_home_url(); ?>/img/wl_ig.png"></li>
				<br>
				<li><img src="<?php echo get_home_url(); ?>/img/wl_tw.png"></li>
				<li><img src="<?php echo get_home_url(); ?>/img/wl_yt.png"></li>
			</ul>
