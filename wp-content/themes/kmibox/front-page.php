	...
	<section id="como-consigo-kmibox" class="rowtext-center">
		<div class="container" style="margin-top: 5%">
			<div class="col-xs-12 col-md-10 col-md-offset-1">
				...
				<span style="/* text-align:  center; */margin-left: 30%;font-size: 22px;color: #000000;  text-align: center;font-family: PoetsenOne_Regular;border: 3px solid #091705;   border-radius: 27px;padding: 3px 8px;">2</span>
				<span style="/* text-align:  center; */margin-left: 31%;font-size: 22px;color: #000000;  text-align: center;font-family: PoetsenOne_Regular;border: 3px solid #091705;   border-radius: 27px;padding: 3px 9px;">3</span>
				</div>
				<div class="row hidden-xs">
					...
					<span style="/* text-align:  center; */margin-left: -25%;font-size: 22px;color: #000000;  text-align: center;font-family: PoetsenOne_Regular;border: 3px solid #091705;   border-radius: 27px;padding: 4px 9px;">4</span>
