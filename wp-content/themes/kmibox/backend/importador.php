<?php
	echo "
		<script type'text/javascript'> var TEMA = '".TEMA()."'; </script>

		<script src='".TEMA()."/backend/recursos/js/jquery-1.12.4.min.js'></script>
		<script src='".TEMA()."/backend/recursos/js/jquery.dataTables.min.js'></script>
		<script src='".TEMA()."/backend/recursos/js/dataTables.bootstrap4.min.js'></script>
