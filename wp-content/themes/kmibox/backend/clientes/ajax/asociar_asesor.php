<?php
	...
	$HTML = '
		<form id="asociar_asesor">
			...
			<div class="celdas_1">
				<div class="input_box">
					<label>Indique c&oacute;digo del asesor:</label>
					<input type="text" id="codigo" name="codigo" />
				</div>
			</div>
			<div class="botonera_container">
				<input type="button" value="Crear" name="update" onClick="asociarAsesor()" class="button button-primary button-large" />
			</div>
		</div>
	';
